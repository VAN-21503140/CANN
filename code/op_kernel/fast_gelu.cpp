...
public:
    ...
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, uint32_t totalLength, uint32_t smallCoreDataNum,
        ...
        pipe_.InitBuffer(absBuf_, tileDataNum_ * sizeof(DT_X));
        pipe_.InitBuffer(denomBuf_, tileDataNum_ * sizeof(DT_X));
        pipe_.InitBuffer(workBuf_, tileDataNum_ * sizeof(DT_X));
    }
